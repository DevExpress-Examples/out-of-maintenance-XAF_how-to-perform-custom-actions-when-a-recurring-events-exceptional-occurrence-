...
Namespace CustomSchedulerEvent.Win
	Partial Public Class CustomSchedulerEventWindowsFormsApplication
		...
		Private Sub CustomSchedulerEventWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
